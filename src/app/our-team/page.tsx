...
export const metadata: Metadata = {
  title: 'Our Team',
  description:
    'Meet the officers and sales team of Prestige Golf Access & Clubshares, Inc., with public business contact and registration details.',
};

const leadership = TEAM_MEMBERS.filter(
  (member) => member.group === 'Leadership & Directors',
);

const salesLeadership = TEAM_MEMBERS.filter(
  (member) => member.group === 'Sales Leadership',
);
...
function telephoneHref(value: string) {
  ...
  if (normalized.startsWith('+02')) {
    return `tel:+632${normalized.slice(3)}`;
  }
    ...
    >
      <div className="shell">
        <Reveal className="team-group-head">
          ...
          <p>
            Public business contact and registration details are presented
            clearly for convenient reference.
          </p>
        </Reveal>
        ...
        <div className="shell team-closing-grid">
          <Reveal>
            <p className="eyebrow light">
              Work with PGA Clubshares
            </p>

            <h2>
              Ready to discuss a{' '}
              <em>club share requirement?</em>
            </h2>
          </Reveal>

          <Reveal
            delay={100}
            className="team-closing-copy"
          >
            <p>
              Whether you are exploring a purchase, sale, or lease, our team
              can help you review the next practical step.
            </p>
